...
$url ="https://script.google.com/macros/s/AKfycbzrtOrTXsG9B5AFFj7W0mheIdKebAz7I6nozij0SxCIgK2FHTyssVNjj8fZ_lvpT7IT/exec";
 $ch = curl_init($url);
...
$result = curl_exec($ch);
 ...
 $rgt = "INSERT INTO seller (name,email,gender,password,status) VALUES ('$name','$email','$gender','$password','Pending')";
