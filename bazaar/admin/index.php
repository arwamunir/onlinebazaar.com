...
<div class="row">
    ...
    <form method="POST" action="" enctype="multipart/form-data">
      ...
      <div class="col-md-12 ">
        ...
        <label style="font-size: 17px;" id="c" >Email:</label>
      ...
      <div class="row">
        <div class="col-lg-12">
         ...
         <label style="font-size: 17px;" id="c" >Password:</label>
...
if (isset($_POST['submit'])) {
  ...
  if ($user_email == $email  &&  $user_password == $password) {
    ...
    $_SESSION['yid'] = $user_id;       // Storing the value in session
  
    $_SESSION['yemail'] = $user_email; // Storing the value in session
    $_SESSION['ypassword'] = $user_password; // Storing the value in session
